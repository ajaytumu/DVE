        ...
        if priority_column == "Y":
            ...
            try:
                ...
                if not compare.matches(ignore_extra_columns=False):
                    add_row = [tid, 'Full_Check', source_file, target_tablename, 'Fail']
                    ...
                    print("pass")
                    add_row = [tid, 'Full_Check', source_file, target_tablename, 'Success']
                    df_full.loc[i] = add_row
            ...
            try:
                if source_databasename != "None" and source_tablename != "None" and target_databasename != "None" and target_tablename != "None":
                    ...
                    if not compare.matches(ignore_extra_columns=False):
                        ...
                        add_row = [tid, 'Full_Check', source_tablename, target_tablename, 'Fail']
                        df_full.loc[i] = add_row
                        df_full.to_excel(fileDir + '\\' + 'Report_for_Full_Check' + '.xlsx', index=False)
                        zip_list.append(tid)
                        ...
                        add_row = [tid, 'Full_Check', source_tablename, target_tablename, 'Success']
                ...
                add_row = [tid, 'Full_Check', source_tablename, target_tablename, e]
                df_full.loc[i] = add_row
                df_full.to_excel(fileDir + '\\' + 'Report_for_Full_Check' + '.xlsx', index=False)
